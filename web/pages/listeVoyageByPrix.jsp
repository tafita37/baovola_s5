                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md d-flex">
                                                <div class="form-group p-2">
                                                    <label for="#">Minimal Price</label>
                                                    <div class="form-field">
                                                        <div class="select-wrap">
                                                            <div class="icon"><span class="fa fa-chevron-down"></span></div>
                                                            <input type="number" name="prix_min" id="" class="form-control" placeholder="Minimal Price">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md d-flex">
                                                <div class="form-group p-2">
                                                    <label for="#">Maximal Price</label>
                                                    <div class="form-field">
                                                        <div class="select-wrap">
                                                            <div class="icon"><span class="fa fa-chevron-down"></span></div>
                                                            <input type="number" name="prix_max" id="" class="form-control" placeholder="Maximal Price">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
